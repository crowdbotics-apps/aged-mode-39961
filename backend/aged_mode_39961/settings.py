"""
Django settings for aged_mode_39961 project.
...
ROOT_URLCONF = 'aged_mode_39961.urls'
...
WSGI_APPLICATION = 'aged_mode_39961.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "aged_mode_39961 API",
    "DESCRIPTION": "API documentation for aged_mode_39961 App",
    "VERSION": "v1",
}
